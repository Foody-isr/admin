      ...
      <div className="min-h-screen flex items-center justify-center bg-page">
        <div className="w-full max-w-sm">
          <div className="card text-center">
            ...
            <h2 className="text-lg font-semibold text-fg-primary mb-2">Account Ready!</h2>
            <p className="text-sm text-fg-secondary">Your account has been set up. Redirecting to your dashboard…</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-page">
      <div className="w-full max-w-sm">
        ...
        <div className="card">
          <h2 className="text-lg font-semibold text-fg-primary mb-1">Set Up Your Account</h2>

            ...
            <div key={group.id} className="rounded-xl border border-[var(--divider)] bg-[var(--surface)] overflow-hidden">
              ...
              {isExpanded && (
                <div className="border-t border-[var(--divider)]">
                  ...
                  {/* Add Item Row */}
                  <button
                    onClick={() => router.push(`/${rid}/menu/items/new?category=${group.id}`)}
...
function ItemRow({ item, restaurantName, menu, t, rid, onDelete }: {
  item: MenuItem;
  ...
  return (
    ...
    >
      ...
      <div className="relative flex justify-center" onClick={(e) => e.stopPropagation()}>
        ...
        {dropdownOpen && (
          <div className="absolute right-0 top-8 z-30 w-44 bg-[var(--surface-elevated,var(--surface))] border border-[var(--divider)] rounded-xl shadow-lg overflow-hidden">
            <button

          ...
          <div className="flex-1 overflow-y-auto px-2 pb-3">
            {activePage === 'home' ? (
              ...
              <div className="px-3 py-4 space-y-5">
                ...
                <div className="rounded-lg border border-[var(--divider)] p-3 bg-surface-subtle">
                  <p className="text-xs text-fg-secondary mb-2">
                    Theme, typography, layout and branding for the menu/order page now live in their own pages:
                  </p>
                  <div className="flex flex-col gap-1.5">
                    <a href={`/${restaurantId}/website/menu/themes`}
                       className="text-xs font-medium text-brand-500 hover:underline">
                      → Themes
                    </a>
                    <a href={`/${restaurantId}/website/menu/typography`}
                       className="text-xs font-medium text-brand-500 hover:underline">
                      → Typography
                    </a>
                    <a href={`/${restaurantId}/website/menu/branding`}
                       className="text-xs font-medium text-brand-500 hover:underline">
                      → Branding
                    </a>
                  </div>
